# `pdfcpu_jll.jl` (v0.11.1+0)

[![deps](https://juliahub.com/docs/pdfcpu_jll/deps.svg)](https://juliahub.com/ui/Packages/General/pdfcpu_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/010e1ce541dd3327833ab545aa8090167ac4fbaa/P/pdfcpu/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `pdfcpu_jll.jl` have been built from these sources:

* git repository: https://github.com/pdfcpu/pdfcpu.git (revision: `c4b560df8f597da81cfcd21eef1ed1fefbea6a34`)

## Platforms

`pdfcpu_jll.jl` is available for the following platforms:
